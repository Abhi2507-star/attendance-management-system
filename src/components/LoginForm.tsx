...
function LoginForm({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-10 relative z-50">
      <motion.div
      ...
      >
        <div className="grid gap-10 md:grid-cols-[1.1fr,1fr] items-center">
          ...
          >
            <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl px-8 py-10 shadow-2xl shadow-black/40">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl px-6 py-7 sm:px-8 sm:py-9 shadow-2xl shadow-black/40"
          >
            <motion.div className="mb-6 text-center" variants={itemVariants} custom={0}>
              <h2 className="text-2xl font-bold text-white">
                CyberVidya Attendance
              </h2>
              <p className="text-sm text-slate-200/75 mt-2">
            ...
            >
              ...
              <motion.div variants={itemVariants} custom={1}>
                <label
                  htmlFor="username"
                  className="text-xs font-semibold text-slate-200/90 uppercase tracking-[0.18em]"
                >
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-slate-900/50 border border-white/20 px-3.5 py-2.5 text-sm text-white outline-none focus:ring-2 focus:ring-emerald-500/40"
                  required
                />
              </motion.div>
              ...
              <motion.div variants={itemVariants} custom={2}>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl bg-slate-900/50 border border-white/20 px-3.5 py-2.5 pr-10 text-sm text-white outline-none focus:ring-2 focus:ring-emerald-500/40"
                    required
                  />
              ...
              <motion.div
                ...
                custom={3}
                className="flex items-center gap-2 text-xs text-slate-200/85"
              >
                <input
                  type="checkbox"
                  checked={rememberMe}
                  onChange={(e) => setRememberMe(e.target.checked)}
                  className="h-4 w-4 rounded border-white/30 bg-slate-900/50 text-emerald-400"
                />
              ...
              <motion.div
                variants={itemVariants}
                custom={4}
                className="text-[11px] text-slate-200/70"
              >
              ...
              {error && (
                <motion.p
                  variants={itemVariants}
                  custom={5}
                  className="px-3 py-2 text-xs rounded-xl bg-red-500/10 border border-red-500/40 text-red-100"
                >
                  {error}
                </motion.p>
              )}
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="w-full bg-emerald-500 text-slate-900 font-semibold rounded-xl py-2.5 hover:bg-emerald-400 transition shadow-lg shadow-emerald-500/40"
              >
